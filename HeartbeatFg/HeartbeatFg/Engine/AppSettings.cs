...
namespace HeartbeatFg.Engine
{
    public class AppSettings
    {
        ...
        public static string SelectedDeviceId
        {
            get
            {
                Object tmpVal = Windows.Storage.ApplicationData.Current.LocalSettings.Values["selectedDeviceId"];
                if (tmpVal == null)
                {
                    return "";
                }
            ...
            set
            {
                Windows.Storage.ApplicationData.Current.LocalSettings.Values["selectedDeviceId"] = value;
            }
        }
